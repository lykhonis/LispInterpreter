...
public class LispFloatp extends LispAbstractCommand {

	public LispFloatp(LispList parameters, LispGlobal global) throws LispException {
	...
	public LispAtom execute(LispArguments arguments) throws LispException {
		...
		result = new LispBoolean(atom.isDouble());
