...
public class LispNumberEqual extends LispAbstractCommand {

	public LispNumberEqual(LispList parameters, LispGlobal global) throws LispException {
	...
	public LispAtom execute(LispArguments arguments) throws LispException {
		...
		result = ((LispNumber) atomLeft).isEqualTo((LispNumber) atomRight);
