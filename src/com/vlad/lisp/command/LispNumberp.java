...
public class LispNumberp extends LispAbstractCommand {

	public LispNumberp(LispList parameters, LispGlobal global) throws LispException {
	...
	public LispAtom execute(LispArguments arguments) throws LispException {
		...
		result = new LispBoolean(atom.isNumber());
