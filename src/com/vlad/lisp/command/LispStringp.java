...
public class LispStringp extends LispAbstractCommand {

	public LispStringp(LispList parameters, LispGlobal global) throws LispException {
	...
	public LispAtom execute(LispArguments arguments) throws LispException {
		...
		result = new LispBoolean(atom.isString());
