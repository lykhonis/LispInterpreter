...
public class LispNumberLessOrEqual extends LispAbstractCommand {

	public LispNumberLessOrEqual(LispList parameters, LispGlobal global) throws LispException {
	...
	public LispAtom execute(LispArguments arguments) throws LispException {
		...
		result = ((LispNumber) atomLeft).isLessOrEqualTo((LispNumber) atomRight);
