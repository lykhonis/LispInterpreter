...
public class LispNumberLess extends LispAbstractCommand {

	public LispNumberLess(LispList parameters, LispGlobal global) throws LispException {
	...
	public LispAtom execute(LispArguments arguments) throws LispException {
		...
		result = ((LispNumber) atomLeft).isLessThan((LispNumber) atomRight);
