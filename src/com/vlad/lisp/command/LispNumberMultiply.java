...
public class LispNumberMultiply extends LispAbstractCommand {

	public LispNumberMultiply(LispList parameters, LispGlobal global) throws LispException {
	...
	public LispAtom execute(LispArguments arguments) throws LispException {
		...
		for (int i = 1; i < getParameters().size(); i++) {
			...
			if (result == null) {
				...
				result = result.multiply((LispNumber) atom);
			}
		}
