...
public class LispIntegerp extends LispAbstractCommand {

	public LispIntegerp(LispList parameters, LispGlobal global) throws LispException {
	...
	public LispAtom execute(LispArguments arguments) throws LispException {
		...
		result = new LispBoolean(atom.isInteger());
