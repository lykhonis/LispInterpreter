...
public class LispNumberDivide extends LispAbstractCommand {

	public LispNumberDivide(LispList parameters, LispGlobal global) throws LispException {
	...
	public LispAtom execute(LispArguments arguments) throws LispException {
		...
		for (int i = 1; i < getParameters().size(); i++) {
			...
			if (result == null) {
				...
				result = result.divide((LispNumber) atom);
			}
		}
