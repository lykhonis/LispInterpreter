...
public class LispNumberNotEqual extends LispAbstractCommand {

	public LispNumberNotEqual(LispList parameters, LispGlobal global) throws LispException {
	...
	public LispAtom execute(LispArguments arguments) throws LispException {
		...
		result = ((LispNumber) atomLeft).isNotEqualTo((LispNumber) atomRight);
